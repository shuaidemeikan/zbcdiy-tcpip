...
typedef struct _sock_ops_t
{
    ...
    net_err_t (*recvfrom) (struct _sock_t* s, void* buf, size_t len, int flags, const struct x_sockaddr* src, x_socklen_t src_len, ssize_t* result_len);
